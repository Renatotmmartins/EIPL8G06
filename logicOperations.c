...
/**
 * \brief Operação de comparação de valores. Se o tipo do #Value de x for uma string ou array e o tipo do #Value y for um inteiro devolve o #Value que está nesse índice.
 * @param x   o elemento do tipo #Value 
 * @param y   o elemento do tipo #Value 
...
/**
 * \brief Verifica se o primeiro argumento é menor que o segundo. Se o tipo do #Value x for array ou string e o tipo do #Value y for um inteiro fica com os primeiros y elementos.
 * @param x   o elemento do tipo #Value 
 * @param y   o elemento do tipo #Value 
 * @return    1 se for verdade, 0 se for falso
 */
...
/**
 * \brief Verifica se o primeiro argumento é maior que o segundo. Se o tipo do #Value x for uma string ou array e o tipo do #Value y for um inteiro fica com os y últimos elementos.
 * @param x   o elemento do tipo #Value 
 * @param y   o elemento do tipo #Value 
 * @return    1 se for verdade, 0 se for falso
 */
